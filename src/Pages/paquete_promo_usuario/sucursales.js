...
class promo_sucursal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            // data: {},
    ...
    componentDidMount() {
        SSocket.sendPromise({
            "component": "sucursal",
            "type": "getByKeyPaquete",
            "key_paquete": this.params.key_paquete
        }).then((e) => {
            // if (e.estado != "exito");
    ...
    render_with_data() {
        ...
        return <SList2
            ...
            render={(data) => {
                return <Sucursal.Card image={1} data={data} root={'/paquete/membresia/detalle'}
                    key_servicio={this.params.key_servicio}
                    key_sucursal={data.key}
                    params={{
                        pk:this.params.key_paquete,
                        sucursal:data.key
                    }}
                />
            }}
...
export default connect(initStates)(promo_sucursal);