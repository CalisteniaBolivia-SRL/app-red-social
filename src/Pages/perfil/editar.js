    ...
    getForm() {
        ...
        return <SForm
            ...
            inputs={{
                ...
                CI: { label: "CI", isRequired: true, defaultValue: this.data.CI, editable: false },
                Nombres: { label: "Nombres", isRequired: true, defaultValue: this.data.Nombres, editable: false },
                Apellidos: { label: "Apellidos", isRequired: true, defaultValue: this.data.Apellidos, editable: false },
                "Telefono": { label: "Telefono", defaultValue: this.data["Telefono"], type: "phone", editable: false },
                Correo: { label: "Correo", type: "email", isRequired: true, defaultValue: this.data.Correo, editable: false },
                detalle_app: { label: "Presentación", type: "textArea", isRequired: true, defaultValue: this.data.detalle_app, style: { borderRadius: 8, borderWidth: 0.5, borderColor: "cyan" } },
                Nit: { label: "Nit", type: "number", isRequired: true, defaultValue: this.data.Nit, style: { borderRadius: 8, borderWidth: 0.5, borderColor: "cyan" } },
                RazonSocial: { label: "Razón Social", isRequired: true, defaultValue: this.data.RazonSocial, style: { borderRadius: 8, borderWidth: 0.5, borderColor: "cyan" } },
