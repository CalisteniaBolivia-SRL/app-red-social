...
class StatusBar extends Component {
    ...
    render() {
        ...
        this.hilo();
        return (
            <SView col={"xs-12"} height={20} backgroundColor={STheme.color.primary} >
                <SView col={"xs-12"} row flex style={{
                    paddingLeft: 8, paddingRight: 8,
                }}>
                    <SView width={30} center flex >
                        <SText fontSize={14} color={STheme.color.text}>{this.state.hora}</SText>
                    </SView>
                    <SView row >
                        <SView width={25} center  >
                            <SIcon name={"AppSignal"} width={18} fill={this.state.isConected ? STheme.color.text: STheme.color.lightGray} />
                        </SView>
                        <SView width={30} center  >
                            <SIcon name={"AppWifi"} width={19} fill={this.state.isConected ? STheme.color.text : STheme.color.lightGray} />
                        </SView>
                        <SView width={25} center  >
                            <SIcon name={"AppBaterry"} width={25} fill={STheme.color.text} />
                        </SView>
                    </SView>
                </SView>
            </SView>
